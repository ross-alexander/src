...
extern "C" int luaopen_NetAddr(lua_State *L)
{
  ...
  lua_newtable(L);
  lua_pushcclosure(L, NetAddr___tostring, 0);
  lua_setfield(L, -2, "__tostring");
  lua_pushcclosure(L, NetAddr___gc, 0);
  lua_setfield(L, -2, "__gc");
  lua_pushcclosure(L, NetAddr___lt, 0);
  lua_setfield(L, -2, "__lt");
  lua_pushcclosure(L, NetAddr___eq, 0);
  lua_setfield(L, -2, "__eq");

  lua_newtable(L);
  lua_pushcclosure(L, NetAddr_resolve, 0);
