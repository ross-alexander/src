...
#define MAX_SAMP_FREQ   48000.0         // maximum allowed sample frequency [Hz]
#define RMS_WINDOW_TIME     0.050       // Time slice size [s]
#define STEPS_per_dB      100.          // Table entries per dB
#define MAX_dB            120.          // Table entries for 0...MAX_dB (normal max. values are 70...80 dB)

#define MAX_ORDER               (BUTTER_ORDER > YULE_ORDER ? BUTTER_ORDER : YULE_ORDER)
//#define MAX_SAMPLES_PER_WINDOW  (MAX_SAMP_FREQ * RMS_WINDOW_TIME)      // max. Samples per Time slice
#define PINK_REF                64.82 //298640883795                              // calibration value
#define MAX_SAMPLES_PER_WINDOW 2400
#define MAX_STEPS 120000
...
int              freqindex;
int              first;
static Uint32_t  A [MAX_STEPS];
static Uint32_t  B [MAX_STEPS];
