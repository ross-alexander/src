...
typedef struct _grip_gui {
  ...
  int x;
  int y;
  GtkStyleContext *style_wb;
  GtkStyleContext *style_LCD;
  GtkStyleContext *style_dark_grey;
...
gboolean CheckTracks(DiscInfo*);
void InitProgram(GripInfo *);
...
typedef void (*GripReplyCallback)(gint, gpointer);

int grip_app_warning(GtkWidget*, const char*);
int grip_app_ok_cancel_modal(GtkWidget*, const char*, GCallback, gpointer);
