	  ...
	  switch (action)
		...
		*pl = pos;
	    ...
	    case DASM_IMM_B:
	      CK((n & ((1<<((ins>>10)&31))-1)) == 0, RANGE_I);
	      //	      n >>= ((ins>>10)&31);
	      printf("dasm_put DASM_IMM_B %04x %d\n", ins, n);
	      b[pos++] = n;
	      break;
	...
	while (1)
	  {
		...
		case DASM_REL_LG: case DASM_REL_PC_B: case DASM_REL_PC_J: pos++; break;
		case DASM_LABEL_LG: case DASM_LABEL_PC: b[pos++] += ofs; break;
		case DASM_IMM_I: case DASM_IMM_S: case DASM_IMM_B: case DASM_IMM_U: case DASM_IMM_J:
	...
	while (1)
	  ...
	  /* fallthrough */
		...
		patchrel:
		  ...
		  int imm = 0;
		  imm |= (offset & 0x1000) << 19; // imm 12 -> 31
